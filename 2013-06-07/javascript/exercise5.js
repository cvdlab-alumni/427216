...
function strada(x,y,nc,t){

	var s1 = SIMPLEX_GRID([[(t+t)*nc],[6,-4,6,-4,6,-4,6,-4,6,-4]]);
	s1 = T([0,1])([x,y])(s1);
	...
	console.log(row);
	var s2 = SIMPLEX_GRID([row,[50]]);
	s2 = T([0,1])([x,y])(s2);

	return STRUCT([s1,s2]);
}

var s1 = strada(50,0,7,4);
var s2 = strada(-100,0,5,5);

s2 = T([1])([-10])(s2);


var s = STRUCT([terrain,l,ins,ins2,s1,s2]);
DRAW(s);